    ...
    <div className="card">
      <div className="card-body">
        ...
        <ul className="list-unstyled">
          <li>
            <h6 className="fw-bold">IT Intern Sep. 2021 - Dec. 2021</h6>
            <p>
              Assisted with the installation and testing of a new security
              software suite on servers and endpoints.
            </p>
            <p>
